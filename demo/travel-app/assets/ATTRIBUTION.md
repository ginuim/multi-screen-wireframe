# Shanghai map background attribution

`shanghai-map.svg` is a cropped, label-free, grayscale derivative of
[Shanghai districts map](https://commons.wikimedia.org/wiki/File:Shanghai_districts_map.svg)
by Peter Fitzgerald and OpenStreetMap contributors.
